...
UPDATE FCT_HullDescription SET Description = '轻型巡洋舰' WHERE HullDescriptionID = 7; /* Light Cruiser */
...
UPDATE FCT_HullDescription SET Description = '战列舰' WHERE HullDescriptionID = 10; /* Battleship */
UPDATE FCT_HullDescription SET Description = '无畏舰' WHERE HullDescriptionID = 11; /* Dreadnought */
...
UPDATE FCT_HullDescription SET Description = '殖民舰' WHERE HullDescriptionID = 27; /* Colony Ship */
UPDATE FCT_HullDescription SET Description = '勘测舰' WHERE HullDescriptionID = 28; /* Survey Ship */
UPDATE FCT_HullDescription SET Description = '科研船' WHERE HullDescriptionID = 30; /* Science Vessel */
UPDATE FCT_HullDescription SET Description = '导弹巡洋舰' WHERE HullDescriptionID = 31; /* Missile Cruiser */
UPDATE FCT_HullDescription SET Description = '跃迁巡洋舰' WHERE HullDescriptionID = 32; /* Jump Cruiser */
...
UPDATE FCT_HullDescription SET Description = '施工舰' WHERE HullDescriptionID = 35; /* Construction Ship */
...
UPDATE FCT_HullDescription SET Description = '深空勘测舰' WHERE HullDescriptionID = 46; /* Deep Space Survey Ship */
...
UPDATE FCT_HullDescription SET Description = '舰载艇' WHERE HullDescriptionID = 72; /* Pinnace */
...
UPDATE FCT_HullDescription SET Description = '攻击艇' WHERE HullDescriptionID = 76; /* Attack Craft */
UPDATE FCT_HullDescription SET Description = '点防御基地' WHERE HullDescriptionID = 77; /* Point Defence Base */
UPDATE FCT_HullDescription SET Description = '跃迁驱逐舰' WHERE HullDescriptionID = 78; /* Jump Destroyer */
UPDATE FCT_HullDescription SET Description = '快速侦察艇' WHERE HullDescriptionID = 79; /* Fast Scout Craft */
...
UPDATE FCT_HullDescription SET Description = '拦截机' WHERE HullDescriptionID = 82; /* Interceptor */
...
UPDATE FCT_HullDescription SET Description = '战斗侦察机' WHERE HullDescriptionID = 92; /* Fighter-Scout */
UPDATE FCT_HullDescription SET Description = '侦察战斗机' WHERE HullDescriptionID = 93; /* Scout Fighter */
UPDATE FCT_HullDescription SET Description = 'ICBM 发射基地' WHERE HullDescriptionID = 94; /* ICBM Launch Base */
...
UPDATE FCT_HullDescription SET Description = '跃迁战列巡洋舰' WHERE HullDescriptionID = 104; /* Jump Battlecruiser */
UPDATE FCT_HullDescription SET Description = '跃迁护航驱逐舰' WHERE HullDescriptionID = 105; /* Jump Destroyer Escort */
...
UPDATE FCT_HullDescription SET Description = '补给舰' WHERE HullDescriptionID = 109; /* Replenishment Ship */
UPDATE FCT_HullDescription SET Description = '维修基地' WHERE HullDescriptionID = 110; /* Maintenance Base */
UPDATE FCT_HullDescription SET Description = '远程勘测舰' WHERE HullDescriptionID = 111; /* Long Range Survey Ship */
...
UPDATE FCT_HullDescription SET Description = '突击穿梭机' WHERE HullDescriptionID = 114; /* Assault Shuttle */
...
UPDATE FCT_HullDescription SET Description = '空投指挥舰' WHERE HullDescriptionID = 119; /* Command Dropship */
...
UPDATE FCT_HullDescription SET Description = '登陆突击艇' WHERE HullDescriptionID = 123; /* Landing Craft Assault */
UPDATE FCT_HullDescription SET Description = '装甲巡洋舰' WHERE HullDescriptionID = 124; /* Armoured Cruiser */
UPDATE FCT_HullDescription SET Description = '星际虫群' WHERE HullDescriptionID = 125; /* Star Swarm */
UPDATE FCT_HullDescription SET Description = '光束防御基地' WHERE HullDescriptionID = 126; /* Beam Defence Base */
UPDATE FCT_HullDescription SET Description = '发射复合体' WHERE HullDescriptionID = 127; /* Launch Complex */
UPDATE FCT_HullDescription SET Description = '指挥舰' WHERE HullDescriptionID = 128; /* Command Ship */
UPDATE FCT_HullDescription SET Description = '护卫舰旗舰' WHERE HullDescriptionID = 129; /* Frigate Leader */
UPDATE FCT_HullDescription SET Description = '辅助运输船' WHERE HullDescriptionID = 130; /* Auxiliary Transport */
...
UPDATE FCT_HullDescription SET Description = '护送空投舰' WHERE HullDescriptionID = 135; /* Dropship Escort */
...
UPDATE FCT_HullDescription SET Description = '勘测艇' WHERE HullDescriptionID = 153; /* Survey Craft */
UPDATE FCT_HullDescription SET Description = '探索舰' WHERE HullDescriptionID = 155; /* Exploration Ship */
UPDATE FCT_HullDescription SET Description = '跃迁侦察舰' WHERE HullDescriptionID = 156; /* Jump Scout */
UPDATE FCT_HullDescription SET Description = '侦擦基地' WHERE HullDescriptionID = 157; /* Scout Base */
UPDATE FCT_HullDescription SET Description = '跳点防御基地' WHERE HullDescriptionID = 158; /* Jump Point Defence Base */
UPDATE FCT_HullDescription SET Description = '引导 FAC' WHERE HullDescriptionID = 159; /* FAC Tender */
UPDATE FCT_HullDescription SET Description = '战斗机运输船' WHERE HullDescriptionID = 160; /* Fighter Transport */
UPDATE FCT_HullDescription SET Description = '战斗机存储船' WHERE HullDescriptionID = 161; /* Fighter Storage */
...
UPDATE FCT_HullDescription SET Description = '快速侦察船' WHERE HullDescriptionID = 164; /* Fast Scout */
UPDATE FCT_HullDescription SET Description = '高速侦察船' WHERE HullDescriptionID = 165; /* High Speed Scout */
...
UPDATE FCT_HullDescription SET Description = '地形改造基地' WHERE HullDescriptionID = 169; /* Terraforming Base */
UPDATE FCT_HullDescription SET Description = '快速巡逻艇' WHERE HullDescriptionID = 170; /* Fast Patrol Craft */
UPDATE FCT_HullDescription SET Description = '基地星球' WHERE HullDescriptionID = 171; /* Base Star */
UPDATE FCT_HullDescription SET Description = '突袭船' WHERE HullDescriptionID = 172; /* Raider */
UPDATE FCT_HullDescription SET Description = '轨道防御监视船' WHERE HullDescriptionID = 173; /* Orbital Defence Monitor */
UPDATE FCT_HullDescription SET Description = '战列巡洋舰旗舰' WHERE HullDescriptionID = 174; /* War Cruiser Leader */
UPDATE FCT_HullDescription SET Description = '弹药运输船' WHERE HullDescriptionID = 175; /* Ammunition Transport */
...
UPDATE FCT_HullDescription SET Description = '医疗船' WHERE HullDescriptionID = 180; /* Hospital Ship */
UPDATE FCT_HullDescription SET Description = '救援穿梭机' WHERE HullDescriptionID = 181; /* Rescue Shuttle */
UPDATE FCT_HullDescription SET Description = '娱乐船' WHERE HullDescriptionID = 182; /* Recreational Ship */
UPDATE FCT_HullDescription SET Description = '传感器平台' WHERE HullDescriptionID = 183; /* Sensor Platform */
UPDATE FCT_HullDescription SET Description = '空投船母舰' WHERE HullDescriptionID = 184; /* Dropship Carrier */
UPDATE FCT_HullDescription SET Description = '维修舰' WHERE HullDescriptionID = 185; /* Repair Ship */
UPDATE FCT_HullDescription SET Description = '侦察驱逐舰' WHERE HullDescriptionID = 186; /* Scout Destroyer */
UPDATE FCT_HullDescription SET Description = '救生筏' WHERE HullDescriptionID = 187; /* Lifeboat */
UPDATE FCT_HullDescription SET Description = 'FAC 指挥' WHERE HullDescriptionID = 188; /* FAC Leader */
UPDATE FCT_HullDescription SET Description = 'FAC 运输船' WHERE HullDescriptionID = 189; /* FAC Transport */
...
UPDATE FCT_HullDescription SET Description = '跃迁殖民地船' WHERE HullDescriptionID = 192; /* Jump Colony Ship */
UPDATE FCT_HullDescription SET Description = '可移动星门' WHERE HullDescriptionID = 193; /* Mobile Jump Gate */
...
UPDATE FCT_HullDescription SET Description = '重型货轮' WHERE HullDescriptionID = 201; /* Heavy Freighter */
...
UPDATE FCT_HullDescription SET Description = '武装商船' WHERE HullDescriptionID = 208; /* Carrack */
UPDATE FCT_HullDescription SET Description = '运输船' WHERE HullDescriptionID = 209; /* Transport */
...
UPDATE FCT_HullDescription SET Description = '情报舰' WHERE HullDescriptionID = 212; /* Intelligence Ship */
UPDATE FCT_HullDescription SET Description = '轨道防御基地' WHERE HullDescriptionID = 213; /* Orbital Defence Base */
UPDATE FCT_HullDescription SET Description = '蜂巢舰' WHERE HullDescriptionID = 214; /* Hive Ship */
UPDATE FCT_HullDescription SET Description = '勘测巡洋舰' WHERE HullDescriptionID = 215; /* Survey Cruiser */
UPDATE FCT_HullDescription SET Description = '跳点稳定船' WHERE HullDescriptionID = 216; /* Stabilisation Ship */
...
UPDATE FCT_HullDescription SET Description = '轻型跃迁巡洋舰' WHERE HullDescriptionID = 229; /* Light Jump Cruiser */
...
UPDATE FCT_HullDescription SET Description = '侦察艇' WHERE HullDescriptionID = 237; /* Recon Craft */
UPDATE FCT_HullDescription SET Description = '地质勘探艇' WHERE HullDescriptionID = 238; /* Geological Survey Craft */
...
UPDATE FCT_HullDescription SET Description = '侦察艇' WHERE HullDescriptionID = 244; /* Scout Boat */
UPDATE FCT_HullDescription SET Description = '外交空间站' WHERE HullDescriptionID = 245; /* Diplomatic Station */
UPDATE FCT_HullDescription SET Description = '外交舰' WHERE HullDescriptionID = 246; /* Diplomatic Ship */
...
UPDATE FCT_HullDescription SET Description = '跃迁运输船' WHERE HullDescriptionID = 266; /* Jump Transport */
...
UPDATE FCT_HullDescription SET Description = '快艇' WHERE HullDescriptionID = 273; /* Schnellboot */
UPDATE FCT_HullDescription SET Description = '拦截基地' WHERE HullDescriptionID = 274; /* Interceptor Base */
UPDATE FCT_HullDescription SET Description = '休闲空间站' WHERE HullDescriptionID = 275; /* Recreational Station */
UPDATE FCT_HullDescription SET Description = '支持基地' WHERE HullDescriptionID = 276; /* Support Base */
UPDATE FCT_HullDescription SET Description = '供应运输船' WHERE HullDescriptionID = 277; /* Supply Transport */
UPDATE FCT_HullDescription SET Description = '军事补给舰' WHERE HullDescriptionID = 278; /* Military Replenishment Ship */
...
UPDATE FCT_HullDescription SET Description = '钛轰炸机' WHERE HullDescriptionID = 287; /* TIE Bomber */
